...
export const APP_ERROR_CODES = {
	...
	CLOSE_DATA_UNAVAILABLE: true,
	DESKTOP_RUNTIME_UNAVAILABLE: true,
	EXPORT_DIAGNOSTICS_FAILED: true,
	INTERNAL: true,
