...
export function MetricTile({ label, value, attention, wide }: MetricTileProps) {
	return (
		<div
			className={`min-w-0 rounded-xl border border-(--border-neutral) bg-(--surface-inset) px-3 py-2.5 ${wide ? 'col-span-2 lg:col-span-1' : ''}`}
		>
